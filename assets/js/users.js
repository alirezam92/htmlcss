document.addEventListener('DOMContentLoaded', function() {
    ...
    const addUserButtom = document.getElementById('add_user_buttom')
    addUserButtom.addEventListener('click', ()=>{
    ...
    //                           <td>
    //                             <i class="material-icon orange-text darken-3 m-l-5 m-r-5 hov-pointer">edit</i>
    //                             <i class="material-icon red-text darken-3 m-l-5 m-r-5 hov-pointer">delete_forever</i>
    //                           </td>
